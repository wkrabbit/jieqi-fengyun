...
import { INITIAL_LAYOUT } from '../engine/constants'
...
export const useBoardStore = defineStore('board', () => {
  ...
  function initBoard() {
    pieces.value = INITIAL_LAYOUT.map(p => ({ ...p }))
  ...
  return { pieces, grid, initBoard, movePiece, revealPiece, removePiece, resetBoard }
})
